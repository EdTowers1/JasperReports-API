...
// Los servicios de reportes que dependían de BD están temporalmente
// deshabilitados
 ...
 * }
 * 
 * public byte[] exportarReporteClientes(List<Cliente> clientes, String
 * template) {
 ...
 * JRBeanCollectionDataSource(clientes);
 * Map<String, Object> parameters = new HashMap<>();
 * JasperPrint jasperPrint = JasperFillManager.fillReport(jasperReport,
 * parameters, dataSource);
 * return JasperExportManager.exportReportToPdf(jasperPrint);
 * } catch (Exception e) {
 * throw new ReportException("Error al exportar el reporte Jasper: " + template,
 * e);
 * }
 * }
 * }
