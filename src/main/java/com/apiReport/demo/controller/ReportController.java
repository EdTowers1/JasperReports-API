...
// Los reportes que dependían de BD están temporalmente deshabilitados
// Si necesitas habilitar BD en el futuro, descomenta este código
 ...
 * 
 * public ReportController(ClienteService clienteService, ReportService
 * reportService) {
 ...
 * .header(HttpHeaders.CONTENT_DISPOSITION, "attachment; filename=cliente_" + id
 * + ".pdf")
 ...
 * byte[] pdf = reportService.exportarReporteClientes(clientes,
 * "clientes.jrxml");
 * return ResponseEntity.ok()
 ...
 * return
 * ResponseEntity.ok("La API de reportes está funcionando correctamente.");
 * }
 * }
 */
